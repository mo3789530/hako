...
- [ ] TenantとGitHub App Installation/Repositoryを対応付け、Repository Registry APIとRBACを追加する（Owner/Admin向けInstallation claimの作成・一覧APIとpending/active binding・Repository registry schemaを追加。GitHub callback検証、active化、Repository同期APIは未実装）。
